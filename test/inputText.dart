...
void main() async {
  getMecthApi();
 // hmacSha1('GET\nFri, 27 Dec 2024 06:09:39 GMT\nhttp://dev.mctech.vip/api/mquantity/organizations-parent?parentId=-1',
 //      'wJZApqPSQuJBwm9Qa1oJ2fmLXT2bhrQc9yX5U/3x');
}
...
Future<dynamic>  getMecthApi() async {
  ...
  const path = 'http://dev.mctech.vip/api/mquantity/organizations-parent?=-1';
  var options = {
    'accessId': accessId,
    'secret': secretKey,
    'method': 'GET',
...
String hmacSha1(String content, String key)  {
  ...
  print('sing=$base64Encoded');
  print('sing=pHm8aJCimO9IyV8zNYCb8uZXVG0=');
